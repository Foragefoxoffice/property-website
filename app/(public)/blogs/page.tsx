...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      ...
      description: data.blogSeoMetaDescription_en || 'Read the latest news, tips, and guides from 183 Housing Solutions.',
      openGraph: {
        title: data.blogSeoOgTitle_en || data.blogSeoMetaTitle_en,
        description: data.blogSeoOgDescription_en || data.blogSeoMetaDescription_en,
