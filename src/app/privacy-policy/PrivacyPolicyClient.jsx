...
export default function PrivacyPolicyClient({ data, loading }) {
    ...
    const contentTitle = language === 'en'
        ? data?.privacyPolicyContentTitle_en
        : data?.privacyPolicyContentTitle_vn;

    const contentBody = language === 'en'
        ? data?.privacyPolicyContent_en
        : data?.privacyPolicyContent_vn;
