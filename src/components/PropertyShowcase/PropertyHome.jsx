...
import { Share2, Heart, LayoutGrid, ChevronLeft, ChevronRight, Image as ImageIcon, Printer, MapPin } from "lucide-react";
...
export default function PropertyHome({ property }) {
    ...
    const handleShare = async () => {
        ...
        const shareData = {
            ...
            text: `${t.checkOutProperty || 'Check out'} ${title}`,
        ...
        if (navigator.share) {
            ...
            try {
                ...
                CommonToaster(t.linkCopied || "Link copied", "success");
            } catch (err) {
                console.error("Failed to copy:", err);
                CommonToaster(t.failedCopy || "Failed to copy", "error");
            }
        }
    };
    ...
    return (
        <div className="max-w-[1280px] mx-auto px-4 md:px-6 py-8 bg-[#F8F7FC]">
            ...
            {/* Photo Grid (Desktop) / Slider (Mobile) */}
