...
import type { DayButtonProps, DropdownProps, RootProps, WeekNumberProps, ChevronProps } from "react-day-picker"
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        WeekNumber: ({ week, children, ...weekProps }: WeekNumberProps) => {
          return (
            <td {...weekProps}>
